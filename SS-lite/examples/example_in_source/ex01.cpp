 ...
 *
 * Using the library in a Petsc executable .  ( This example implements all of these steps ) 
 *
 ...
 *
 *    ./<executable>.exe ... -ksp_type KSPSS -pc_type none -ksp_ss_filestem <C50 filestem> -ksp_ss_featureset <featureSetName> 
 *
 ...
 *             ii) <filestem>.names
 *             iii) <filestem>.tree 
 *             iv) IMPORTANT <filestem>.solvers IMPORTANT -- This file is not automatiically generated by C5.0
 *             
 ...
 *
 *    Some example command line sets are 
 *
 *    ./ex01.ss -f ./matrix/1138_bus.pbin -ksp_type preonly -pc_type lu 
 *    ./ex01.ss -f ./matrix/1138_bus.pbin -ksp_type gmres -pc_type hypre -pc_hypre_type boomeramg
 *    
 *  
 *
 *    ./ex01.ss -f ./matrix/1138_bus.pbin -ksp_type KSPSS -pc_type none -ksp_ss_filestem models/example -ksp_ss_featureset example
 *
 *
 *     --- All the standard Petsc command line options still work. Some good ones are:
 *        -- -ksp_view    to print out the ksp information for the solver used
 *           -log_view    to print out the petsc logs. 
 *           -mat_view    to print out the matrix 
 *           -ksp_monitor to print out the residual history (if a iterative solver is selected ) 
 *
 ******************** TODO ***************************************
