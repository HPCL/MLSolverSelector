...
// Feature Set Include 
 namespace FeatureExtraction_example { int ExtractJacobianFeatures(Mat J, int edge, int interior, std::map<std::string, double> &fnames, bool matvecs); }  

// Feature Set Include 
 namespace FeatureExtraction_full { int ExtractJacobianFeatures(Mat J, int edge, int interior, std::map<std::string, double> &fnames, bool matvecs); }  
