...
#define _ANTISYMMETRICFROBENIUSNORM 1
  ...
  // TTODO -- Prob could just delete them -- I think if <undefind-macro> fails --- 
...
#define SYMMETRY (SYMMETRICITY || NONZEROPATTERNSYMMETRY || SYMETRICINFINITYNORM || SYMMETRICFROBENIUSNORM || ANTISYMMETRICFROBENIUSNORM || ANTISYMMETRICINFINITYNORM ) 

# FEATURECOUNT(npoints) MAXCOUNT + MINCOUNT + COLCOUNT*npoints + SUMCOUNT + SYMMETRY*npoints*npoints 
