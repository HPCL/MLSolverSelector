...
#ifndef exampleFeatureExtraction_H
#define exampleFeatureExtraction_H
...
#define SUMCOUNT (NNZ + AVGNONZEROSPERROW  + ABSOLUTENONZEROSUM + FROBENIUSNORM + AVERAGEDIAGONALDISTANCE + ROWVARIANCE + TRACE + ABSOLUTETRACE + DIAGONALNONZEROS +DIAGONALMEAN +  DIAGONALAVERAGE ) 
...
#define SYMMETRY (SYMMETRICITY || NONZEROPATTERNSYMMETRY || SYMMETRICINFINITYNORM || SYMMETRICFROBENIUSNORM || ANTISYMMETRICFROBENIUSNORM || ANTISYMMETRICINFINITYNORM ) 
#define FEATURECOUNT(npoints) MAXCOUNT + MINCOUNT + COLCOUNT*npoints + SUMCOUNT + SYMMETRY*npoints*npoints 


namespace FeatureExtraction_example {
