//Classifier for C50Core.h. --- Massive Licencing ISSUES -- DO NOT DISTRIBUTE --  
// Copied almost directly from C50 library and wrapped as C++ interface. 


#include "C50Core.h"


const char* c50_sRelOps[] = {">=", "<=", "!=", "<>", ">", "<", "=", (const char*) 0};
const char* c50_sAddOps[] = {"+", "-", (String) 0};
const char* c50_sMultOps[] = {"*", "/", "%", (String) 0};
const char* c50_sFuncs[] = {"sin", "cos", "tan", "log", "exp", "int", (const char*) 0};
const char*	c50_sProp[]= {"null",
                 "att",
                 "class",
                 "cut",
                 "conds",
...
/*      -----------  */
{
    ...
    if ( (o = FindOne(c50_sRelOps)) >= 0 )
    {
        BN += strlen(c50_sRelOps[o]);
...
/*      ----  */
{
    ...
    while ( (o = FindOne(c50_sMultOps)) >= 0 )
    {
        BN += 1;
...
/*      ----  */
{
    ...
    else if ( (o = FindOne(c50_sFuncs)) >= 0 )
    {
        BN += 3;
...
/*  --------  */
{
    ...
    *Delim = c;
    ...
    return Which(PropName, c50_sProp, 1, PROPS);
}
